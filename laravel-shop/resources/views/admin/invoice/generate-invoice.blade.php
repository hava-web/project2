...
<body>
    ...
    <table class="order-details">
        <thead>
            <tr>
                <th width="50%" colspan="2">
                    <h2 class="text-start">Laravel Shop</h2>
                </th>
                <th width="50%" colspan="2" class="text-end company-data">
                    <span>Invoice Id: #{{ $order->id }}</span> <br>
                    <span>Date: {{ $order->created_at->format('Y-m-d') }}</span> <br>
                    <span>Address: {{ $order->user->customer->address }}</span> <br>
                </th>
            </tr>
            <tr class="bg-blue">
        ...
        <tbody>
            <tr>
                ...
                <td>Full Name:</td>
                <td>{{ $order->user->customer->fullname }}</td>
            </tr>
            <tr>
                <td>Payment Mode:</td>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="15%" class="fw-bold">${{ $item->product->selling_price * $item->quantity }}</td>
            </tr>
            @php
    ...
    <br>
    <p class="text-center">
        Thank your for shopping with Laravel Shoping
    </p>
