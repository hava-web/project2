        ...
        <div class="container">
                ...
                <div class="col-md-12">
                    <div class="shadow bg-white p-3">
                        ...
                        <hr>
                            ...
                            <div class="row">
                                <h3 style="color: #4e73df">Place Order</h3>
                                <p><b>{{ $customer->fullname }}, {{ $customer->phone }}</b> {{ $customer->address }}</p>
            ...
            @else
               <div class="card card-body shadow p-md-5">
                   ...
                   <a href="{{ url('collections') }}" class="btn btn-warning">Go Back to Shop</a>
               </div>
            @endif
        </div>
    </div>
...
@push('scripts')
    <script src="https://www.paypal.com/sdk/js?client-id=AfGXDk7gaO27gJS4pT4S3uten2_yElasfscutuR6t96_KH11St1hYT8uoqsQABd-3UAo61R0WOXnoH9u&currency=USD"></script>
    <script>
        paypal.Buttons({
