                        ...
                        @if ($product->productColors->count() > 0)
                            @if ($product->productColors)
                                @foreach ($product->productColors as $color)
                                    ...
                                    <label for="" class="colorSelectionLabel " style="background-color: {{ $color->color->code }}" wire:click="colorSelected({{ $color->id }})">
                                        {{ $color->color->name }}
                                    </label>
                                @endforeach
                            @endif
    ...
    <div class="container">
        <div class="row">
            ...
            < class="row">
                                ...
                                <div class="item">
                                    <div class="product-card">
                                        ...
                                        <div class="product-card-body">
                                            ...
                                            <a href="{{ url('/collections/'.$relatedProduct->category->slug.'/'.$relatedProduct->name) }}">
                                                    {{ $relatedProduct->name }} 
                                            </a>
                                            </h5>
                                            <div>
                ...
                @else
                    <div class="p-2">
                        <h4>No Related Product Available for {{ $category->name }}</h4>
                    </div>
                @endif
            </div>
